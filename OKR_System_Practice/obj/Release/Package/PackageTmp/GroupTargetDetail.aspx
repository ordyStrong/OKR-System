...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<asp:DropDownList ID="tagetMember" runat="server"></asp:DropDownList>--%>
    ...
    <div class="groupGoal">
        ...
        <asp:ListView ID="groupGoalListView" runat="server" DataSourceID="SqlDataSource2" DataKeyNames="targetName" ItemPlaceholderID="groupGoalPlaceHolder" OnItemDataBound="groupGoalListView_ItemDataBound">
            ...
            <ItemTemplate>
                ...
                <%-- <p>
                    <label>References :</label>
                    <a href='<%# "/Files/" + Eval("targetId") %>'><%# Eval("targetName") %>  </a>
                </p>--%>
                <div style="margin-bottom: 10px;">
            ...
            <EditItemTemplate>
                <div style="margin-bottom: 10px;">
                    <label>group name :</label>
                    <%--<asp:TextBox ID="groupIdBoxFake" runat="server"  Text='' Width="100px" />--%><%--<asp:TextBox ID="groupIdBox" runat="server"  Text='<%# Bind("groupId") %>' Width="100px" />--%>
                    <%--<asp:DropDownList ID="GroupNameDropDownList" Enabled="false" SelectedValue='<%# Bind("groupId") %>' runat="server"></asp:DropDownList>--%>
